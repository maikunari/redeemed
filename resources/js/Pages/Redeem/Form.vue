                        ...
                        <div class="relative">
                            <div v-show="!showContactForm">
                                ...
                                <div v-if="downloadStarted && isLoading">
                                    ...
                                    <div class="p-6 bg-green-50 rounded-lg text-center flex flex-col items-center justify-center">
                                        <svg class="animate-spin w-16 h-16 text-indigo-600 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                        </svg>
                                ...
                                <div v-if="showSuccess">
                                    ...
                                    <div class="p-6 bg-green-50 rounded-lg text-center">
                                        ...
                                        <div class="mt-4">
                                            <button @click="resetForm" class="text-indigo-600 hover:text-indigo-800 underline bg-transparent border-none p-0 shadow-none cursor-pointer">Enter Another Code</button>
                                        </div>
                                    </div>
                                </div>
